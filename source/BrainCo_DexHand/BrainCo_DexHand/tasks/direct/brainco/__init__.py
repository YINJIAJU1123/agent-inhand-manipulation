...
gym.register(
    id="BrainCo-Direct-Revo3-SemanticReorient-Cube-v0",
    entry_point=f"{inhand_task_entry}.semantic_reorient:SemanticReorientEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.brainco_hand_semantic_reorient_env_cfg:BrainCoHandSemanticReorientEnvCfg",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:BrainCoHandPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_cfg.yaml",
    },
